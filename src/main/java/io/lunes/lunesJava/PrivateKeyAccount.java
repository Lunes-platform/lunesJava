...
import static io.lunes.lunesJava.Hash.*;
...
public class PrivateKeyAccount extends PublicKeyAccount {
    ...
    public static PrivateKeyAccount fromSeed(String seed,  byte chainId) {
        return new PrivateKeyAccount(privateKey(seed, 0), chainId);
    }
